export const categoryOptions = ["mmorpg", "shooter", 'strategy', 'moba', 'racing', 'sports',
...
export const platformOptions = ["pc", "browser", "all"]

export const sortOptions = ["release-date", "alphabetical", "popularity"]